...
public class StudentHistoryServiceImpl implements StudentHistoryService {
    ...
    @Override
    public List<ExamHistoryResponse> getHistory(Integer studentId) {
        return attemptRepo.findByStudent_Id(studentId).stream().map(a -> {
    ...
    @Override
    public ExamHistoryDetailWrapper getHistoryDetail(Integer attemptId) {
